...
const classes = {
  account: "p-4 space-2",
  modal:
    "flex flex-col w-[95vw] h-[45vh] justify-between m-auto p-8 rounded-xl shadow-lg shadow-slate-500/50 border-solid border-2 border-slate-300 bg-white",
  ...
  backdrop:
    "hidden js__backdrop flex flex-col justify-center bg-black/90 fixed h-[100vh] w-[100vw] top-0 right-0 z-32",
  form: "flex flex-col",
  dangertext: "text-red-800 font-bold",
  message: "border-red-800 active:outline-red-800",
  buttonwrapper: "flex space-4",
  dangercancelbutton:
    "btn bg-yellow-50 text-emerald-950 border-solid border-2 border-red-800",
