...
const classes = {
  ...
  emblaContainer: 'flex ',
  emblaSlide: 'group/item overflow-clip flex-[0_0_95%] min-w-0 space-y-2 p-2 bg-yellow-50 rounded-xl shadow-lg shadow-slate-500/50 border-solid border-2 border-slate-300 m-8',
