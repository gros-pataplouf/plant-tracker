...
const classes = {
  ...
  mobileMenu: "bg-emerald-950 text-cream flex flex-col justify-center items-center p-4 fixed top-0 left-0 right-0 w-screen h-screen z-10 font-roboto-700 text-2xl [&>*:not(:first-child)]:my-8",
  mobileMenuClose: "absolute top-4 right-4", 
  hamburger: " sm:invisible [&>img]:ml-auto"
}
